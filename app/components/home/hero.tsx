        ...
        <div className="container mx-auto flex justify-center h-full max-h-screen">
            <div className="flex flex-col items-center  mt-32  relative">
                <div className="text-hero flex flex-col items-center">
                    <div className="font-extrabold text-transparent text-5xl  tracking-wide bg-gradient-to-r from-secondary via-indigo-800 to-blue-600 bg-clip-text">
                ...
                <button className='bg-black text-white px-4 py-2 mt-6 rounded-lg font-semibold hover:bg-secondary duration-500'>
                    Get Started
                </button>
